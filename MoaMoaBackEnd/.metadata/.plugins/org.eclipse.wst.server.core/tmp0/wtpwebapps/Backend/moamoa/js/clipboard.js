        ...
        3: [
            function (e, t, n) {
                ...
                n.nodeList = function (e) {
                    ...
                    ) && "length" in e && (0 === e.length || n.node(e[0]))
                },
                n.string = function (e) {
        ...
        6: [
            function (e, t, n) {
                ...
                i.prototype = {
                    on: function (e, t, n) {
                        var i = this.e || (this.e = {});
                        return (i[e] || (i[e] = [])).push({fn: t, ctx: n}),
                        this
                    },
                    once: function (e, t, n) {
                        function i() {
                            ...
                            return a(e, [
                                {
                                    ...
                                    value: function e() {
                                        ...
                                        this
                                            .fakeElem
                                            .addEventListener("focus", window.scrollTo(0, i)),
                                    ...
                                    set: function e(t) {
                                        if (void 0 !== t) {
                                            ...
                                            if ("copy" === this.action && t.hasAttribute("disabled")) 
                                                throw new Error(
                                                    'Invalid "target" attribute. Please use "readonly" instead of "disabled" attrib' +
                                                    'ute'
                                                );
                                            if ("cut" === this.action && (t.hasAttribute("readonly") || t.hasAttribute("disabled"))) 
                                                throw new Error(
                                                    'Invalid "target" attribute. You can\'t cut text from elements with "readonly" ' +
