...
(function (t) {
                ...
                var i = e.isWindow || e.isDocument
                    ...
                    s = e.isWindow || e.isDocument
                        ...
                        : e
                            .element
                            .css("overflow-y"),
                    n = "scroll" === i || "auto" === i && e.width < e
                        .element[0]
                        .scrollWidth,
                    o = "scroll" === s || "auto" === s && e.height < e
                        .element[0]
                        .scrollHeight;
                return {
                    width: o
    ...
    t
        .effects
        .define("blind", "hide", function (e, i) {
            var s = {
                    up: [
                        "bottom", "top"
                    ],
    ...
    t
        .effects
        .define("explode", "hide", function (e, i) {
            function s() {
                b.push(this),
                b.length === u * d && n()
            }
    ...
    t
        .effects
        .define("fade", "toggle", function (e, i) {
            var s = "show" === e.mode;
            t(this)
                .css(
                    "opacity",
    ...
    t
        .effects
        .define("highlight", "show", function (e, i) {
            var s = t(this),
                n = {
        ...
        .define("scale", function (e, i) {
            var s = t(this),
                ...
                a = t.extend(!0, {
                    ...
                    to: t
                        .effects
                        .scaledDimensions(s, o, e.direction || "both"),
    ...
    t
        .effects
        .define("pulsate", "show", function (e, i) {
            var s = t(this),
                n = e.mode,
                o = "show" === n,
                a = "hide" === n,
    ...
    t
        .effects
        .define("slide", "show", function (e, i) {
            var s,
                n,
                o = t(this),
                a = {
        ...
        return "area" === l
            ...
            : (
                /^(input|select|textarea|button|object)$/.test(l)
                    ? (r = !i.disabled, r && (h = t(i).closest("fieldset")[0], h && (
                        r = !h.disabled
                    )))
                    : r = "a" === l
                        ? i.href || s
    ...
    t.extend(t.expr[":"], {
        focusable: function (e) {
            return t
                .ui
                .focusable(e, null != t.attr(e, "tabindex"))
        }
    }),
    t.ui.focusable,
    t.fn.form = function () {
    ...
    t.widget("ui.accordion", {
        ...
        _refresh: function () {
            ...
            this
                ._addClass(this.active, "ui-accordion-header-active", "ui-state-active")
            ...
            "fill" === s
                ...
                : "auto" === s && (e = 0, this.headers.next().each(function () {
        ...
        _keydown: function (e) {
            ...
            switch (e.keyCode) {
                ...
                case t.ui.keyCode.RIGHT:
                    this.active && !this
                        .active
                        .is(".ui-state-disabled") && this.expand(e);
                    break;
        ...
        _setOption: function (t, e) {
            if ("icons" === t) {
                var i = this
                    ...
                    .find(".ui-menu-icon");
                this
                    ._removeClass(i, null, this.options.icons.submenu)
    ...
    t.widget("ui.autocomplete", {
            ...
            this._on(this.menu.element, {
                mousedown: function (e) {
                    ...
                    this._delay(function () {
                        ...
                        this.element[0] !== t
                            .ui
                            .safeActiveElement(this.document[0]) && this
                            .element
                            .trigger("focus")
                    })
                },
        ...
        _isEventTargetInWidget: function (e) {
            var i = this
                .menu
                .element[0];
            return e.target === this.element[0] || e.target === i || t.contains(
                i,
                e.target
            )
        },
    ...
    t.widget("ui.controlgroup", {
        ...
        _destroy: function () {
            ...
            this
                .element
                .removeAttr("role"),
            this.options.items.controlgroupLabel && this
                .element
                    ...
                    ? "controlgroupLabel" === s
                        ? (
                            ...
                            o.each(function () {
                                var e = t(this);
                                e
                                    .children(".ui-controlgroup-label-contents")
                                    .length || e
                                    .contents()
        ...
        refresh: function () {
            ...
            "horizontal" === this.options.direction && this._addClass(
                null,
                "ui-helper-clearfix"
            ),
            this._initWidgets(),
    ...
    t.widget("ui.checkboxradio", [
        t.ui.formResetMixin, {
            ...
            _create: function () {
                ...
                "radio" === this.type && this._addClass(
                    this.label,
            ...
            _readType: function () {
                ...
                "input" === e && /radio|checkbox/.test(this.type) || t.error(
                    "Can't create checkboxradio on element.nodeName=" + e + " and element.type=" +
                    this.type
                )
            },
            _enhance: function () {
            ...
            _toggleClasses: function () {
                ...
                this.options.icon && "checkbox" === this.type && this
                    ._toggleClass(
                        this.icon,
                        null,
    ...
    t.widget("ui.button", {
        ...
        _updateTooltip: function () {
            this.title = this
                .element
                .attr("title"),
            this.options.showLabel || this.title || this
                .element
    ...
    t.uiBackCompat !== !1 && (
        ...
        t.fn.button = function (e) {
            return function () {
                return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr(
                    "type"
        ...
        t.fn.buttonset = function () {
            ...
            "option" === arguments[0] && "items" === arguments[1] && arguments[2]
                ...
                : "option" === arguments[0] && "items" === arguments[1]
                    ? this
                        .controlgroup
                        .apply(this, [arguments[0], "items.button"])
                    : (
                        ...
                        T += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + I +
                            ...
                            /all|right/.test(I) && 0 === k
                                ? Y
                                    ...
                                    : o
                                : ""
                        ) + this._generateMonthYearHeader(t, Z, te, Q, J, k > 0 || C > 0, f, g) + "</di" +
            ...
            drag: function (e, i, s) {
                ...
                for (d = s.snapElements.length - 1; d >= 0; d--) 
                    ...
                    u = c + s
                        .snapElements[d]
                        .height,
                    h - g > _ || m > l + g || c - g > b || v > u + g || !t.contains(
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _setupHandles: function () {
            ...
            this._handles = this
                ._handles
                .add(this.element.find(".ui-resizable-handle")),
            this
                ._handles
                .disableSelection(),
            this
    ...
    t
        ...
        .add("resizable", "ghost", {
            start: function () {
                ...
                t.uiBackCompat !== !1 && "string" == typeof e.options.ghost && e
                    .ghost
            ...
            resize: function () {
                ...
                e.ghost && e
                    .ghost
                    .css({position: "relative", height: e.size.height, width: e.size.width})
            },
            stop: function () {
                var e = t(this).resizable("instance");
                e.ghost && e.helper && e
    ...
    t.widget("ui.dialog", {
        ...
        _moveToTop: function (e, i) {
            ...
            return o >=+ this
                .uiDialog
                .css("z-index") && (this.uiDialog.css("z-index", o + 1), s = !0),
        ...
        _createTitlebar: function () {
            ...
            this._on(this.uiDialogTitlebar, {
                mousedown: function (e) {
                    t(e.target).closest(".ui-dialog-titlebar-close") || this
                        .uiDialog
                        .trigger("focus")
                }
            }),
        ...
        _size: function () {
            ...
            "auto" === s.height
                ? this
                    .element
                    .css({minHeight: e, maxHeight: i, height: "auto"})
                : this
                    .element
                    .height(Math.max(0, s.height - t)),
            this
                .uiDialog
                .is(":data(ui-resizable)") && this
                .uiDialog
        ...
        _blockFrames: function () {
            this.iframeBlocks = this
                ...
                .map(function () {
                    ...
                    return t("<div>")
                        .css(
                            {position: "absolute", width: e.outerWidth(), height: e.outerHeight()}
                        )
                        .appendTo(e.parent())
                        .offset(e.offset())[0]
                })
                ...
                ? (
                    this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                        ...
                        return i.options.greedy && !i.options.disabled && i.options.scope === s.options.scope && i
                            .accept
                            .call(i.element[0], s.currentItem || s.element) && v(s, t.extend(i, {
                                offset: i
                                    .element
                                    .offset()
    ...
    var v = t.ui.intersect = function () {
        ...
        return function (e, i, s, n) {
            ...
            switch (s) {
                ...
                case "pointer":
                    return t(n.pageY, c, i.proportions().height) && t(
                        n.pageX,
                        l,
                        i.proportions().width
                    );
    ...
    t.widget("ui.progressbar", {
        ...
        _destroy: function () {
            this
                .element
                .removeAttr("role aria-valuemin aria-valuemax aria-valuenow"),
            this
                .valueDiv
                .remove()
        },
                    ...
                    .each(function () {
                        ...
                        i && i.element !== s.element[0] && (
                            ...
                            l
                                ...
                                ), i.selected && (e.metaKey || e.ctrlKey || i.startselected || (
    ...
    t.widget("ui.selectmenu", [
        t.ui.formResetMixin, {
                ...
                this.menuInstance = this
                    ...
                    .menu({
                        ...
                        focus: function (t, i) {
                            ...
                            e
                                .button
                                .attr("aria-activedescendant", e.menuItems.eq(s.index).attr("id"))
                        }
                    })
                    .menu("instance"),
                this
            ...
            _documentClick: {
                mousedown: function (e) {
                    this.isOpen && (
                        t(e.target).closest(".ui-selectmenu-menu, #" + t.ui.escapeSelector(this.ids.button)).length || this.close(e)
                    )
                }
            },
            _buttonEvents: {
            ...
            _select: function (t, e) {
                ...
                this
                    .buttonItem
                    .replaceWith(this.buttonItem = this._renderButtonItem(t)),
                this._setAria(t),
            ...
            _setAria: function (t) {
                ...
                this
                    .button
                    .attr({"aria-labelledby": e, "aria-activedescendant": e}),
                this
                    .menu
                    .attr("aria-activedescendant", e)
            },
            _setOption: function (t, e) {
                if ("icons" === t) {
                    var i = this
                        ...
                        .find("span.ui-icon");
                    this
                        ._removeClass(i, null, this.options.icons.button)
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _createRange: function () {
            ...
            e.range
                ? (
                    ...
                    ("min" === e.range || "max" === e.range) && this._addClass(
                        this.range,
        ...
        values: function (e, i) {
            ...
            if (arguments.length > 1) 
                return this
                    .options
                    .values[e] = this._trimAlignValue(i),
                this._refreshValue(),
                this._change(null, e),
                void 0;
            if (!arguments.length) 
        ...
        _setOption: function (e, i) {
            ...
            switch (
                ...
                case "orientation":
                    this._detectOrientation(),
                    this
                        ._removeClass("ui-slider-horizontal ui-slider-vertical")
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _isFloating: function (t) {
            return /left|right/.test(t.css("float")) || /inline|table-cell/.test(
                t.css("display")
            )
        },
        _create: function () {
        ...
        _mouseStart: function (e, i, s) {
            ...
            if (
                ...
                for (n = this.containers.length - 1; n >= 0; n--) 
                    this
                        .containers[n]
                        ._trigger("activate", e, this._uiHash(this));
        ...
        _mouseDrag: function (e) {
            ...
            for (
                ...
                this.options.scroll && (
                    ...
                    r !== !1 && t.ui.ddmanager && !a.dropBehaviour && t.ui.ddmanager.prepareOffsets(
                        this,
                        e
                    )
                ),
                ...
                if (
                    ...
                    o && s.instance === this.currentContainer && n !== this.currentItem[0] && this.placeholder[
                        1 === o
                            ? "next"
                            : "prev"
        ...
        _intersectsWithPointer: function (t) {
            var e,
                i,
                s = "x" === this.options.axis || this._isOverAxis(
            ...
            if (d) 
                if (1 === this.containers.length) 
                    ...
                    for (
                        ...
                        t.contains(this.containers[p].element[0], this.items[s].item[0]) && this
                            .items[s]
                            .item[0] !== this
                            .currentItem[0] && (
                                h = this.items[s].item.offset()[a],
                                l = !1,
                                e[u] - h > this.items[s][r] / 2 && (
                                    l = !0
                                ),
                                n > Math.abs(e[u] - h) && (
                                    n = Math.abs(e[u] - h),
        ...
        _getRelativeOffset: function () {
            if ("relative" === this.cssPosition) {
                var t = this
                    ...
                    .position();
                return {
                    top: t.top - (parseInt(this.helper.css("top"), 10) || 0) + this
                        .scrollParent
                        .scrollTop(),
                    left: t.left - (parseInt(this.helper.css("left"), 10) || 0) + this
                        .scrollParent
                        .scrollLeft()
                }
            }
        ...
        _convertPositionTo: function (e, i) {
            ...
            var s = "absolute" === e
                    ? 1
                    : -1,
                n = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && t.contains(
                    this.scrollParent[0],
                    this.offsetParent[0]
                )
                    ? this.scrollParent
        ...
        _generatePosition: function (e) {
            var i,
                ...
                o = e.pageX,
                a = e.pageY,
                r = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && t.contains(
                    this.scrollParent[0],
                    this.offsetParent[0]
                )
                    ? this.scrollParent
        ...
        _clear: function (t, e) {
            ...
            if (
                ...
                this
                    ...
                    .show();
            for (
                this.fromOutside && !e && n.push(function (t) {
                    this._trigger("receive", t, this._uiHash(this.fromOutside))
                }),
                !this.fromOutside && this.domPosition.prev === this.currentItem.prev().not(".ui-sortable-helper")[0] && this.domPosition.parent === this.currentItem.parent()[0] || e || n.push(
                    function (t) {
                        this._trigger("update", t, this._uiHash())
                    }
                ),
                this !== this.currentContainer && (e || (
                    n.push(function (t) {
    ...
    t.widget("ui.spinner", {
        ...
        _draw: function () {
            ...
            this
                .buttons
                .height() > Math.ceil(.5 * this.uiSpinner.height()) && this
                .uiSpinner
                .height() > 0 && this
                .uiSpinner
    ...
    t.widget("ui.tabs", {
        ...
        _create: function () {
            ...
            t.isArray(i.disabled) && (
                i.disabled = t.unique(i.disabled.concat(t.map(this.tabs.filter(".ui-state-disabled"), function (t) {
                    return e
                        .tabs
                        .index(t)
                }))).sort()
        ...
        _eventHandler: function (e) {
            ...
            e.preventDefault(),
            o.hasClass("ui-state-disabled") || o.hasClass("ui-tabs-loading") || this.running || a && !i.collapsible || this._trigger(
                "beforeActivate",
                e,
                c
            ) === !1 || (
            ...
            this
                ...
                .each(function () {
                    t.data(this, "ui-tabs-destroy")
                        ? t(this).remove()
                        : t(this).removeAttr(
                            "role tabIndex aria-live aria-busy aria-selected aria-labelledby aria-hidden ar" +
                            "ia-expanded"
                        )
                }),
            this
    ...
    t.widget("ui.tooltip", {
        ...
        _disable: function () {
            ...
            this.disabledTitles = this
                .disabledTitles
                .add(this.element.find(this.options.items).addBack().filter(function () {
                    var e = t(this);
                    return e.is("[title]")
                        ? e
    ...
    t.uiBackCompat !== !1 && t.widget("ui.tooltip", t.ui.tooltip, {
        ...
        _tooltip: function () {
            ...
            return this.options.tooltipClass && t
                .tooltip
