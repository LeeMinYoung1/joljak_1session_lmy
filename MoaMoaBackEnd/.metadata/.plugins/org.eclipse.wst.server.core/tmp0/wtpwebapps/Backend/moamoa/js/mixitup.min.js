...
!function (t) {
    ...
    !function () {
        ...
        "undefined" == typeof n.nextElementSibling && Object.defineProperty(
            t.Element.prototype,
            "nextElementSibling",
            {
                get: function () {
        ...
        function (t) {
            t.matches = t.matches || t.machesSelector || t.mozMatchesSelector || t.msMatchesSelector || t.oMatchesSelector || t.webkitMatchesSelector || function (
                t
            ) {
                return Array
                    .prototype
                    .indexOf
                    .call(this.parentElement.querySelectorAll(t), this) > -1
            }
        }(t.Element.prototype),
    ...
    n = {
        ...
        handleExtendError: function (t, n) {
            ...
            if (t instanceof TypeError && (i = a.exec(t.message))) {
                ...
                throw u > 1 && (
                    s = e.messages.errorConfigInvalidPropertySuggestion({probableMatch: l})
                ),
                r = e
                    .messages
                    .errorConfigInvalidProperty({erroneous: o, suggestion: s}),
                new TypeError(r)
            }
            throw t
        },
        ...
        on: function (e, n, a, i) {
            e && (
                e.addEventListener
                    ...
                    : e.attachEvent && (e["e" + n + a] = a, e[n + a] = function () {
                        e["e" + n + a](t.event)
    ...
    e
        .controlDefinitions
        .push(new e.ControlDefinition("multimix", "[data-filter][data-sort]")),
    e
        .controlDefinitions
        .push(new e.ControlDefinition("filter", "[data-filter]")),
    e
        .controlDefinitions
        .push(new e.ControlDefinition("sort", "[data-sort]")),
    e
        .controlDefinitions
        .push(new e.ControlDefinition("toggle", "[data-toggle]")),
    e.Control = function () {
        e
            .Base
            .call(this),
        ...
        parseStatusChange: function (t, e, n, a) {
            ...
            switch (i.callActions("beforeParseStatusChange", arguments), i.type) {
                ...
                case "sort":
                    e
                        .sort
                        .match(/:asc/g) && (o = e.sort.replace(/:asc/g, "")),
    ...
    n.extend(e.Mixer.prototype, {
        ...
        sanitizeConfig: function () {
            ...
            t.config.controls.scope = t
                .config
                .controls
                .scope
                .toLowerCase()
                .trim(),
            t.config.controls.toggleLogic = t
                .config
                .controls
                .toggleLogic
                .toLowerCase()
                .trim(),
            t.config.controls.toggleDefault = t
                .config
                .controls
                .toggleDefault
                .toLowerCase()
                .trim(),
            t.config.animation.effects = t
                .config
                .animation
                .effects
                .trim(),
        ...
        getInitialState: function () {
            ...
            if (
                ...
                a.startDataset = a.newDataset = n.activeDataset = t
                    .config
                    .load
                    .dataset
                    .slice(),
                ...
                n.activeFilter = t
                    .parseFilterArgs([t.config.load.filter])
                    .command,
                n.activeSort = t
                    .parseSortArgs([t.config.load.sort])
                    .command,
        ...
        insertTargets: function (t, a) {
            ...
            if (
                ...
                for (u = 0; c = t.collection[u]; u++) {
                    ...
                    n.isElement(c, i.dom.document) && c.matches(i.config.selectors.target) && (
                        l = new e.Target,
                        l.init(c, i),
                        l.isInDom = !0,
                    ...
                    : a.targets.length > 0 && "undefined" != typeof t
                        ? i = t < a.targets.length || !a.targets.length
                            ? a
                                ...
                                .el
                            : a
                                .targets[a.targets.length - 1]
                                .dom
                                .el
                                .nextElementSibling
                        : 0 === a.targets.length && a.dom.parent.children.length > 0 && (
        ...
        filterOperation: function (t) {
            ...
            for (
                ...
                n = t.newFilter.collection
                    ? t
                        ...
                        .collection
                        .indexOf(o.dom.el) > -1
                    : "" !== t.newFilter.selector && o
                        .dom
                        .el
                        .matches(t.newFilter.selector),
            ...
            t.matching = t
                .show
                .slice(),
            0 === t.show.length && "" !== t.newFilter.selector && 0 !== e.targets.length && (
                t.hasFailed = !0
            ),
            ...
            if (
                ...
                "random" === t.newSort.order
                    ...
                    : "" === t.newSort.attribute
                        ...
                        : (t.newOrder = t.startOrder.slice(), t.newOrder.sort(function (e, n) {
        ...
        getAttributeValue: function (t, n) {
            ...
            return i = t
                ...
                .el
                .getAttribute("data-" + n),
            null === i && a.config.debug.showWarnings && console.warn(
        ...
        printSort: function (e, a) {
            ...
            for (
                ...
                l.appendChild(f);
            i.dom.parent.firstChild && i.dom.parent.firstChild !== s && l.insertBefore(
        ...
        buildState: function (t) {
            ...
            for (
                ...
                (!t.toRemove.length || t.toRemove.indexOf(i) < 0) && a
                    .targets
                    .push(i.dom.el);
        ...
        goMix: function (a, i) {
            ...
            o.config.animation.duration && o.config.animation.effects && n.isVisible(
                o.dom.container
            ) || (a = !1),
            i.toShow.length || i.toHide.length || i.willSort || i.willChangeLayout || (
                a = !1
            ),
            i.startState.show.length || i.show.length || (a = !1),
            e
                .events
                .fire("mixStart", o.dom.container, {
                    state: i.startState,
                    futureState: i.newState,
                    instance: o
                }, o.dom.document),
            "function" == typeof o.config.callbacks.onMixStart && o
                .config
                .callbacks
                .onMixStart
                .call(o.dom.container, i.startState, i.newState, o),
            n.removeClass(
                o.dom.container,
        ...
        getStartMixData: function (n) {
            ...
            n.startHeight = a.incPadding
                ? o.height
                : o.height - parseFloat(i.paddingTop) - parseFloat(i.paddingBottom) - parseFloat(
                    i.borderTop
                ) - parseFloat(i.borderBottom),
            n.startWidth = a.incPadding
                ? o.width
                : o.width - parseFloat(i.paddingLeft) - parseFloat(i.paddingRight) - parseFloat(
                    i.borderLeft
        ...
        moveTargets: function (t) {
            ...
            a.config.animation.animateResizeContainer && (
                a.dom.parent.style[e.features.transitionProp] = "height " + a.config.animation.duration +
                            "ms ease, width " + a.config.animation.duration + "ms ease ",
                requestAnimationFrame(function () {
                    t.startHeight !== t.newHeight && t.viewportDeltaY !== t.startHeight - t.newHeight && (
                        a.dom.parent.style.height = t.newHeight + "px"
                    ),
                    t.startWidth !== t.newWidth && t.viewportDeltaX !== t.startWidth - t.newWidth && (
        ...
        cleanUp: function (t) {
            ...
            e
                .events
                .fire("mixEnd", a.dom.container, {
                    state: a.state,
                    instance: a
                }, a.dom.document),
            "function" == typeof a.config.callbacks.onMixEnd && a
                .config
                .callbacks
                .onMixEnd
                .call(a.dom.container, a.state, a),
            t.hasFailed && (
            ...
            "function" == typeof a.userCallback && a
                .userCallback
                .call(a.dom.container, a.state, a),
            "function" == typeof a.userDeferred.resolve && a
                .userDeferred
                .resolve(a.state),
            a.userCallback = null,
            a.userDeferred = null,
        ...
        parseMultimixArgs: function (t) {
            ...
            return !i.command.insert || i.command.insert instanceof e.CommandInsert || (
                i.command.insert = a.parseInsertArgs([i.command.insert]).command
            ),
            !i.command.remove || i.command.remove instanceof e.CommandRemove || (
                i.command.remove = a.parseRemoveArgs([i.command.remove]).command
            ),
            !i.command.filter || i.command.filter instanceof e.CommandFilter || (
            ...
            !i.command.changeLayout || i.command.changeLayout instanceof e.CommandChangeLayout || (
        ...
        parseInsertArgs: function (t) {
            ...
            return !i.command.collection.length && a.config.debug.showWarnings && console.warn(
            ...
            for (
                ...
                for (s = 0; o = a.targets[s]; s++) 
                    i
                        .command
                        .collection
                        .indexOf(o.dom.el) > -1 && i
                        .command
                        .targets
                        .push(o);
            return !i.command.targets.length && a.config.debug.showWarnings && console.warn(
        ...
        diffDatasets: function (t) {
            ...
            for (
                ...
                (l = a.cache[d])instanceof e.Target
                    ? (
                        a.config.data.dirtyCheck && !n.deepEquals(s, l.data) && (c = l.render(s), l.data = s, c !== l.dom.el && (
    ...
    n.extend(e.Target.prototype, {
        ...
        applyStylesIn: function (t) {
            ...
            n
                .dom
                .el
                .style[e.features.transformProp] = o.join(" "),
        ...
        applyStylesOut: function (t) {
            ...
            if (
                ...
                void(
                    n.mixer.targetsMoved === n.mixer.targetsImmovable && n.mixer.cleanUp(t.operation)
                );
            switch (
                ...
                n.mixer.config.animation.nudge || "hide" !== t.statusChange || i.push(
            ...
            n
                .dom
                .el
                .style[e.features.transformProp] = i.join(" "),
        ...
        applyTransition: function (t) {
            ...
            n
                .dom
                .el
                .style[e.features.transitionProp] = a,
        ...
        handleTransitionEnd: function (t) {
            ...
            e.isBound && t
                .target
                .matches(e.mixer.config.selectors.target) && (
        ...
        cleanUp: function () {
            ...
            t
                .dom
                .el
                .style[e.features.transformProp] = "",
            t
                .dom
                .el
    ...
    e.Messages = function () {
        e
            ...
            .call(this),
        this.callActions("beforeConstruct"),
        this.ERROR_FACTORY_INVALID_CONTAINER = "[MixItUp] An invalid selector or element reference was passed to the mixitup f" +
                "actory function",
        ...
        this.ERROR_CONFIG_DATA_UID_KEY_NOT_SET = "[MixItUp] To use the dataset API, a UID key must be specified using `data.uidK" +
                "ey`",
        this.ERROR_DATASET_INVALID_UID_KEY = '[MixItUp] The specified UID key "${uidKey}" is not present on one or more data' +
                'set items',
        this.ERROR_DATASET_DUPLICATE_UID = '[MixItUp] The UID "${uid}" was found on two or more dataset items. UIDs must b' +
                'e unique.',
        this.ERROR_INSERT_INVALID_ARGUMENTS = "[MixItUp] Please provider either an index or a sibling and position to insert," +
                " not both",
        this.ERROR_INSERT_PREEXISTING_ELEMENT = "[MixItUp] An element to be inserted already exists in the container",
        this.ERROR_FILTER_INVALID_ARGUMENTS = "[MixItUp] Please provide either a selector or collection `.filter()`, not both",
        this.ERROR_DATASET_NOT_SET = "[MixItUp] To use the dataset API with pre-rendered targets, a starting dataset" +
                " must be set using `load.dataset`",
        this.ERROR_DATASET_PRERENDERED_MISMATCH = "[MixItUp] `load.dataset` does not match pre-rendered targets",
        this.ERROR_DATASET_RENDERER_NOT_SET = "[MixItUp] To insert an element via the dataset API, a target renderer function" +
                " must be provided to `render.target`",
        this.ERROR_SORT_NON_EXISTENT_ELEMENT = "[MixItUp] An element to be sorted does not already exist in the container",
        this.WARNING_FACTORY_PREEXISTING_INSTANCE = "[MixItUp] WARNING: This element already has an active MixItUp instance. The pr" +
                "ovided configuration object will be ignored. If you wish to perform additional" +
                " methods on this instance, please create a reference.",
        this.WARNING_INSERT_NO_ELEMENTS = "[MixItUp] WARNING: No valid elements were passed to `.insert()`",
        this.WARNING_REMOVE_NO_ELEMENTS = "[MixItUp] WARNING: No valid elements were passed to `.remove()`",
        this.WARNING_MULTIMIX_INSTANCE_QUEUE_FULL = "[MixItUp] WARNING: An operation was requested but the MixItUp instance was bus" +
                "y. The operation was rejected because the queue is full or queuing is disabled" +
                ".",
        this.WARNING_GET_OPERATION_INSTANCE_BUSY = "[MixItUp] WARNING: Operations can be be created while the MixItUp instance is " +
                "busy.",
        this.WARNING_NO_PROMISE_IMPLEMENTATION = "[MixItUp] WARNING: No Promise implementations could be found. If you wish to u" +
                "se promises with MixItUp please install an ES6 Promise polyfill.",
        this.WARNING_INCONSISTENT_SORTING_ATTRIBUTES = '[MixItUp] WARNING: The requested sorting data attribute "${attribute}" was not' +
                ' present on one or more target elements which may product unexpected sort outp' +
                'ut',
        this.callActions("afterConstruct"),
